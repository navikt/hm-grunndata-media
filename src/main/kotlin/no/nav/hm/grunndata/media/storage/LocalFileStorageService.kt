...
class FileStorageService: StorageService {
    ...
    override suspend fun uploadStream(inputStream: InputStream, destinationUri: URI, contentType: String): StorageResponse {
        TODO("Not yet implemented")
    }
    ...
    override suspend fun uploadFile(file: CompletedFileUpload, destinationUri: URI): StorageResponse {
        ...
        return withContext(Dispatchers.IO) {
            ...
            val md5 = file.md5Hex()
            StorageResponse(etag = md5, key = key, size = file.size, md5hash = md5)
        }
    }
